...
export declare const KARPENTER = "karpenter";
export declare const RELEASE = "blueprints-addon-karpenter";
/**
 ...
 */
export type Ec2NodeClassV1Spec = Omit<Ec2NodeClassSpec, "amiSelector | subnetSelector"> & Required<Pick<Ec2NodeClassSpec, 'amiSelectorTerms'>>;
/**
